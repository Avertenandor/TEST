...
const config = {
    ...
    bscscan: {
        ...
        apiKeys: {
            PRIMARY: import.meta.env.VITE_BSCSCAN_API_KEY_PRIMARY || 'ZZ3RSBZPMAPK4FV1HUVWE9X13G9ACJWPJX',
            SECONDARY: import.meta.env.VITE_BSCSCAN_API_KEY_SECONDARY || 'ZV525F4QEKK2C3DWNGR69AUF6GG6Y2ZW39',
            AUTHORIZATION: import.meta.env.VITE_BSCSCAN_API_KEY_AUTHORIZATION || 'YA5RH81WYSNS41KQPNNCX74FVXN7DJRJR4',
            DEPOSITS: import.meta.env.VITE_BSCSCAN_API_KEY_DEPOSITS || '2ZJG1N64RZ17GGAMZJU4DKY21GYBERMNY6',
            SUBSCRIPTION: import.meta.env.VITE_BSCSCAN_API_KEY_SUBSCRIPTION || 'ARA9FYMNCIZHTB2PPBSWF686GID9F99P41'
        },
        keyRotation: true,
        currentKeyIndex: 0,
        rateLimit: 5,
